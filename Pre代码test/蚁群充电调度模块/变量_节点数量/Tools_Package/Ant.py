...
class AntColony:
    def __init__(self, distances, num_ants, start_city=0,
                 num_iterations=50, alpha=5.0, beta=2.0, rho=0.5, Q=1.0):
...
def ACO_first(points_list, datas, heu_mat, max_battery, consume, thred, v, eff,
