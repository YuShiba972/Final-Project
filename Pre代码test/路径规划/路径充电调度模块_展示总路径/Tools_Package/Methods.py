...
class AntColony:
    def __init__(self, distances, start_city=0, num_iterations=50,
                 num_ants=10, alpha=5.0, beta=2.0, rho=0.1, Q=1000.0):
    ...
    def plot_iteration_distances(self):
        ...
        plt.plot(x, self.iteration_avgbest, label='平均解的大小')
        plt.plot(x, self.iteration_best, label='最优解')
        plt.legend()
        plt.xlabel('迭代次数')
        plt.ylabel('蚁群算法的解')
        plt.title('蚁群迭代图')
...
class AntColony_ite:
    def __init__(self, distances, start_city=0, num_iterations=50,
                 num_ants=10, alpha=5.0, beta=2.0, rho=0.1, Q=1.0):
        self.distances = distances
        self.start_city = start_city
        self.num_iterations = num_iterations
        self.num_ants = num_ants
