...
class Point:
    ...
    def points10_bar10():
        ...
        G = Point(name='G', location=[2, 1])
        H = Point(name='H', location=[15, 19])
        I = Point(name='I', location=[9, 15])
        J = Point(name='J', location=[17, 11])
        K = Point(name='K', location=[13, 0])

        points_list = [A, B, C, D, E, F, G, H, I, J, K]
...
def draw_map(points, bar_data_file):
    ...
    result_figure.save(Surface=shangetu_bar_goalx, filename='map.jpg')
