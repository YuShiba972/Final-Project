...
def draw_map(points, bar_data_file, filename='Result_Package/测试节点分布图.jpg'):
    ...
    shangetu_bar_goal = result_figure.goal_point(location_l[0:6:], Surface=shangetu_bar)  # 画目标点
    shangetu_bar_goalx = result_figure.goal_point(location_l[5:11:], Surface=shangetu_bar_goal,
                                                  color=[47, 255, 167])  # 画目标点
    shangetu_bar_goalxx = result_figure.goal_point(location_l[10::], Surface=shangetu_bar_goalx,
                                                   color=[255, 47, 167])  # 画目标点
