...
def max_battery(points_list, dis_datas, dis_mat, va_list, va_name='传感器节点最大电池容量', times=30, filename='电池容量变化'):
    # 启发式算法参数
    omiga = 1.0
    gama = 1.0
...
def consume(points_list, dis_datas, dis_mat, va_list, va_name='传感器节点工作功率', times=30, filename='功率变化'):
    # 启发式算法参数
    omiga = 1.0
    gama = 1.0
