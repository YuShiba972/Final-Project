...
def thresholdx(points_list, dis_datas, dis_mat, va_list, va_name, times=30, filename='门限'):
    ...
    name = 'AS-CM'
    plt.plot(va_list, [Gain[0] for Gain in C_ylabs], 'o--', alpha=0.5, linewidth=1, label=name)
    ...
    name = 'AS-CM'
    plt.plot(va_list, [Gain[1] for Gain in C_ylabs], 'o--', alpha=0.5, linewidth=1, label=name)
    ...
    name = 'NJNP'
    plt.plot(va_list, [Gain[0] for Gain in P_ylabs], 'o--', alpha=0.5, linewidth=1, label=name)
    ...
    name = 'AS-CNP'
    plt.plot(va_list, [Gain[0] for Gain in ACO_ylabs], 'o--', alpha=0.5, linewidth=1, label=name)
    ...
    plt.subplot(326)
    name = 'AS-CNP'
    plt.plot(va_list, [Gain[1] for Gain in ACO_ylabs], 'o--', alpha=0.5, linewidth=1, label=name)
    plt.legend()
    plt.xlabel(va_name)
    plt.ylabel('网络效益')
    plt.ylim()
