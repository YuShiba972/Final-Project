...
if __name__ == "__main__":
    ...
    # arg_ll = [(bar_file_10, points_list5, dis_file_5, start_time),
    #           (bar_file_10, points_list10, dis_file_10, start_time),
    #           (bar_file_10, points_list15, dis_file_15, start_time),
    #           (bar_file_10, points_list20, dis_file_20, start_time),
    #           (bar_file_10, points_list25, dis_file_25, start_time),
    #           (bar_file_10, points_list30, dis_file_30, start_time),
    #           (bar_file_10, points_list35, dis_file_35, start_time),
    #           (bar_file_10, points_list40, dis_file_40, start_time)]
    #
    # Run_ACO_Generate_distance(arg_ll)
    # for arg in arg_ll:
    #     ACO_Generate_distance(arg[0], arg[1], arg[2])
    # ACO_Generate_distance(bar_file_10, points_list5, dis_file_5)
    # ACO_Generate_distance(bar_file_10, points_list10, dis_file_10)

    # pool = multiprocessing.Pool(processes=len(arg_ll))
    #
    # pool.map(ACO_Generate_distance, arg for arg in arg_ll)
    #
    # # 关闭进程池
    # pool.close()
    # pool.join()
