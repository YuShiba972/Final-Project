...
def charge_first(points_list, max_battery=10800, consume=200, thred=0.2, v=0.5):
...
def path_first(points_list, max_battery=10800, consume=200, thred=0.2, v=0.5):  # NJNP
    goals_l = points_list[1::]
