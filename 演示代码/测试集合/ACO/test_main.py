...
def cycle_run(map_data, points):  # 获取单个目标点到所有点的最短距离集合
    ...
    for k, i in enumerate(points):
        ...
        distance_list.append(aco.way_len_best)
    return l, distance_list
...
if __name__ == "__main__":
    ...
    # aco.run()  # 迭代运行
    ll, distance_dl = cycle_run(map_data=map_data, points=points)
    way_picture = []
    ...
    print(distance_dl.index(min(distance_dl)))
