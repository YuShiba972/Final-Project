...
def threshold(points_list, dis_datas, dis_mat, va_list, va_name, times=30, name='门限', battery=8000):
    C_ylab1 = []
    C_ylab2 = []
    C_ylab3 = []
    C_ylab4 = []
    ...
    for va in va_list:
        ...
        for i in range(times):
            active_points_list, bat_mat = Point.charge_and_get_bat_mat(points_list, battery)  # 充电并返回新列表，和电量矩阵
            # 电量优先
...
def max_battery(points_list, dis_datas, dis_mat, va_list, va_name, name='电量', times=30, battery=8000):
    C_ylab1 = []
    C_ylab2 = []
    C_ylab3 = []
    C_ylab4 = []
...
def consume(points_list, dis_datas, dis_mat, va_list, va_name, name='消耗', times=30, battery=8000):
    C_ylab1 = []
    C_ylab2 = []
    C_ylab3 = []
    C_ylab4 = []
