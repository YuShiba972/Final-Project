...
if __name__ == "__main__":
    ...
    read(Bg_fig=BarGoal_fig1, Surface=BarGoal_Surf1, po_index=1, input_file=input_file)
    read(Bg_fig=BarGoal_fig2, Surface=BarGoal_Surf2, po_index=2, input_file=input_file)
    read(Bg_fig=BarGoal_fig3, Surface=BarGoal_Surf3, po_index=3, input_file=input_file)
    read(Bg_fig=BarGoal_fig4, Surface=BarGoal_Surf4, po_index=4, input_file=input_file)
    read(Bg_fig=BarGoal_fig5, Surface=BarGoal_Surf5, po_index=5, input_file=input_file)
    read(Bg_fig=BarGoal_fig6, Surface=BarGoal_Surf6, po_index=6, input_file=input_file)
