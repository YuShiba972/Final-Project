...
def plot_ite(args, out_file):
    ...
    plt.plot(draw_list[0][1], draw_list[0][3], label='每代最优平衡因子')
    plt.legend()
    plt.xlabel('迭代次数')
    plt.ylabel('平衡因子')
    ...
    plt.plot(draw_list[1][1], draw_list[1][3], label='每代最优平衡因子')
    plt.legend()
    plt.xlabel('迭代次数')
    plt.ylabel('平衡因子')
    ...
    plt.plot(draw_list[2][1], draw_list[2][3], label='每代最优平衡因子')
    plt.legend()
    plt.xlabel('迭代次数')
    plt.ylabel('平衡因子')
    ...
    plt.plot(draw_list[3][1], draw_list[3][3], label='每代最优平衡因子')
    plt.legend()
    plt.xlabel('迭代次数')
    plt.ylabel('平衡因子')
