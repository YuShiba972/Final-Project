...
class ACO:
    def __init__(self, map_data, start, end, max_iter=50, ant_num=400, pher_imp=1.0, dis_imp=5, evaporate=0.1,
                 pher_init=8) -> None:
        '''
            Params:
            --------
...
def ACO_Generate(bar_data_file, points, filename):
    ...
    for point in points_location_list:
        ...
        for goal_point in tem:
            aco = ACO(map_data=npdata, start=point, end=goal_point, max_iter=1, ant_num=400)
            aco.run()
